...
#+reveal_title_slide: <h1 class=title>%t</h1><h3 class=title>%s</h3><h3 class=date>22-May-2025</h3><h4 class=email>%e</h4>
...
- 19:15 - Break/Buffer
- 19:30 - Using an agentic AI Platform for refactoring code (code elimination) - Iain
